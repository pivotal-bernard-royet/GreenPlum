...
COPY Product_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Store_Dimension.tbl'''
COPY store.Store_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Promotion_Dimension.tbl'''
COPY Promotion_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Vendor_Dimension.tbl'''
COPY Vendor_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Customer_Dimension.tbl'''
COPY Customer_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Employee_Dimension.tbl'''
COPY Employee_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Warehouse_Dimension.tbl'''
COPY Warehouse_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Shipping_Dimension.tbl'''
COPY Shipping_Dimension FROM :input_file DELIMITER '|' NULL '' DIRECT;
...
COPY store.Store_Sales_Fact FROM :input_file DELIMITER '|' NULL '' DIRECT;

\set input_file '''':t_pwd'/Store_Orders_Fact.tbl'''
COPY store.Store_Orders_Fact FROM :input_file DELIMITER '|' NULL '' DIRECT;
...
COPY Inventory_Fact FROM :input_file DELIMITER '|' NULL '' DIRECT;
